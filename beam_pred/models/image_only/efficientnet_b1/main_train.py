...
from models.image_only.efficientnet_b1.model import get_model
...
transform = transforms.Compose([
    transforms.Resize((240, 240)),  # B1 için uygun giriş boyutu
    transforms.ToTensor()
])
...
torch.save(model.state_dict(), "beam_model_b1.pth")
print("Model başarıyla kaydedildi: beam_model_b1.pth")
